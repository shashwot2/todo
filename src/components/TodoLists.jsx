...
const TodoLists = ({ incompleteTodos, completedTodos, editingId, editText, onToggleComplete, onDelete, onEdit, onEditChange }) => {
    ...
    ), [incompleteTodos, editingId, editText, handleEditChange, handleKeyDown, onEdit, onDelete, onToggleComplete]);
    ...
    ), [completedTodos, editingId, editText, handleEditChange, handleKeyDown, onEdit, onDelete, onToggleComplete]);
